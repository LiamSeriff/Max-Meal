...
const GroceryList = () => {
  const ingredients = [
    ...
    { name: "Granola", calories: 471 },
    { name: "Oats", calories: 389 },
    { name: "Black Beans", calories: 227 },
    { name: "Chickpeas", calories: 164 },
    { name: "Quinoa", calories: 120 },
    { name: "Couscous", calories: 112 },
    { name: "Beef Stock", calories: 15 },
    { name: "Chicken Stock", calories: 12 },
    { name: "Cheddar Cheese", calories: 113 },
    { name: "Swiss Cheese", calories: 111 },
    { name: "Feta Cheese", calories: 75 },
    { name: "Cream Cheese", calories: 99 },
    { name: "Tomato Sauce", calories: 29 },
    { name: "Ground Turkey", calories: 120 },
    { name: "Pine Nuts", calories: 191 },
    { name: "Coconut Milk", calories: 150 },
    { name: "Dark Chocolate", calories: 155 },
    { name: "Marshmallows", calories: 100 },
    { name: "Ginger", calories: 2 },
    { name: "Thyme", calories: 3 },
    { name: "Parsley", calories: 5 },
    { name: "Basil Leaves", calories: 2 },
